        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="mb-3">
              ...
              <input id="imageUrl" v-model="editProduct.imageUrl" type="text" class="form-control mb-2" placeholder="請輸入圖片連結">
              <img class="img-fluid" :src="editProduct.imageUrl">
            </div>
            <h3 class="mb-3">多圖新增</h3>
            <!-- 判斷 editProduct.imagesUrl 是否為陣列 -->
            <div v-if="Array.isArray(editProduct.imagesUrl)">
              ...
              <div v-if="editProduct.imagesUrl.length === 0 || editProduct.imagesUrl[editProduct.imagesUrl.length - 1]">
          ...
          <div class="col-sm-8">
            ...
            <div class="row">
              <div class="mb-3 col-md-6">
                ...
                <input id="origin_price" v-model.number="editProduct.origin_price" type="number" min="0"
            ...
            <div class="mb-3">
              ...
              <textarea id="content" v-model="editProduct.content" type="text" class="form-control"
                placeholder="請輸入說明內容">
              </textarea>
            </div>
            <div class="mb-3">
